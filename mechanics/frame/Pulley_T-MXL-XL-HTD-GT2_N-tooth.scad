...
retainer_ht = 1.25;	// height of retainer flange over pulley, standard = 1.5
idler = 1;			// Belt retainer below teeth, 0 = No, 1 = Yes
idler_ht = 1.25;		// height of idler flange over pulley, standard = 1.5
...
//	translate ([0,0, pulley_b_ht + pulley_t_ht + retainer_ht ]) rotate ([0,180,0])
	...
	difference()
	 {	 
        ...
        if (smooth == 1 && profile == 12) {
            cylinder(d = 9.7, h = retainer_ht + idler_ht + pulley_t_ht, $fn = 360);
        }
		...
		translate([0,0,-1])cylinder(r=motor_shaft/2,h=pulley_b_ht + pulley_t_ht + retainer_ht + 2,$fn=360);
