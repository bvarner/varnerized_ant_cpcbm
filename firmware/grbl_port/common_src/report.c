...
static void report_util_line_feed(void) { printPgmString(PSTR("\r\n")); }
static void report_util_feedback_line_feed(void) { serial_write(']'); report_util_line_feed(); }
static void report_util_gcode_modes_G(void) { printPgmString(PSTR(" G")); }
static void report_util_gcode_modes_M(void) { printPgmString(PSTR(" M")); }
static void report_util_comment_line_feed(void) { serial_write(')'); report_util_line_feed(); }
...
static void report_util_setting_string(uint8_t n) {
  ...
  switch(n) {
    ...
    case 40: printPgmString(PSTR("spindle pwm period")); break;
...
{
  printPgmString(PSTR("\r\nGrbl " GOCM3_VERSION " ocm3 ['$' for help]\r\n"));
}

// Grbl help message
void report_grbl_help() {
  #if 0 //ndef REPORT_GUI_MODE
...
void report_grbl_settings() {
  ...
  report_util_float_setting(31,settings.rpm_min,N_DECIMAL_RPMVALUE);
    ...
    report_util_uint32_setting(40,settings.spindle_pwm_period);
